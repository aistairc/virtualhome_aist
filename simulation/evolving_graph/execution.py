...
class JumpExecutor(ActionExecutor):
...
class KneelExcutor(ActionExecutor):
...
class LiftExcutor(ActionExecutor):
...
class SquatExcutor(ActionExecutor):
...
class StrechExcutor(ActionExecutor):
...
class SweepExcutor(ActionExecutor):
...
class StirExcutor(ActionExecutor):
...
class ThrowExcutor(ActionExecutor):
...
class UnfoldExcutor(ActionExecutor):
...
class VacuumExcutor(ActionExecutor):
...
class WrapExcutor(ActionExecutor):
...
class WriteExcutor(ActionExecutor):
...
class FallExcutor(ActionExecutor):
...
class LegoppExcutor(ActionExecutor):
...
class SewExcutor(ActionExecutor):
...
class ShakeExcutor(ActionExecutor):
...
class SmellExcutor(ActionExecutor):
...
class SoakExcutor(ActionExecutor):
